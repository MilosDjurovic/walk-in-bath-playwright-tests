...
11. Bug Title: Email step accepts test@test submission without a top-level domain.
...
5. Add a scroll-position assertion to verify that the active multi-step form remains the viewport focus after each step transition.
